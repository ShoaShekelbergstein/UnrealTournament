...
struct COMMONUI_API FCommonNumberFormattingOptions
{
	...
	FCommonNumberFormattingOptions()
		...
		, MinimumFractionalDigits(FNumberFormattingOptions::DefaultNoGrouping().MinimumFractionalDigits)
		, MaximumFractionalDigits(FNumberFormattingOptions::DefaultNoGrouping().MaximumFractionalDigits)
	{}
...
class COMMONUI_API UCommonNumericTextBlock : public UCommonTextBlock, public FTickableGameObject
{
	GENERATED_BODY()
