...
public:
	...
	{
		ensure(WidgetClass && WidgetClass->ImplementsInterface(UCommonPoolableWidgetInterface::StaticClass()));
	}
	...
	WidgetType* Acquire()
	{
		...
		ICommonPoolableWidgetInterface* const Interface = reinterpret_cast<ICommonPoolableWidgetInterface*>(Result->GetNativeInterfaceAddress(UCommonPoolableWidgetInterface::StaticClass()));
		if (ensure(Interface))
		{
	...
	{
		ICommonPoolableWidgetInterface* const Interface = reinterpret_cast<ICommonPoolableWidgetInterface*>(Widget->GetNativeInterfaceAddress(UCommonPoolableWidgetInterface::StaticClass()));
		if (ensure(Interface))
		{
