...
public:
	...
	void Tick( const FGeometry& AllottedGeometry, const double InCurrentTime, const float InDeltaTime ) override
	{
		...
		if ( bShowSelection != bSelected )
		{
			...
			ICommonListItem::Execute_SetSelected( WidgetObject, bSelected );
		}
	}
	...
	{
		ICommonListItem::Execute_Private_OnExpanderArrowShiftClicked( WidgetObject );
	}
...
protected:
	...
	ESelectionMode::Type GetSelectionMode() const override
	{
		...
		//return ICommonListItem::Execute_GetSelectionMode( WidgetObject );
	}
