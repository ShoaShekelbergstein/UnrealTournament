...
const FName NAME_LightningRiflePrimaryKills(TEXT("LightningRiflePrimaryKills"));
const FName NAME_LightningRifleSecondaryKills(TEXT("LightningRifleSecondaryKills"));
const FName NAME_LightningRifleTertiaryKills(TEXT("LightningRifleTertiaryKills"));
...
const FName NAME_LightningRiflePrimaryDeaths(TEXT("LightningRiflePrimaryDeaths"));
const FName NAME_LightningRifleSecondaryDeaths(TEXT("LightningRifleSecondaryDeaths"));
const FName NAME_LightningRifleTertiaryDeaths(TEXT("LightningRifleTertiaryDeaths"));
...
const FName NAME_LightningRifleShots(TEXT("LightningRifleShots"));
...
const FName NAME_LightningRifleHits(TEXT("LightningRifleHits"));
